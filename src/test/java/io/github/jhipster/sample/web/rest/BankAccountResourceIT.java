...
public class BankAccountResourceIT {
     ...
     */
    public static BankAccountEntity createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static BankAccountEntity createUpdatedEntity(EntityManager em) {
        BankAccountEntity bankAccountEntity = new BankAccountEntity()
            .name(UPDATED_NAME)
            .guid(UPDATED_GUID)
    ...
    public void initTest() {
        bankAccountEntity = createEntity(em);
    }
    ...
    public void createBankAccount() throws Exception {
        ...
        BankAccount bankAccount = bankAccountMapper.toDto(bankAccountEntity);
        ...
        BankAccountEntity testBankAccount = bankAccountList.get(bankAccountList.size() - 1);
    ...
    public void checkNameIsRequired() throws Exception {
        ...
        // set the field null
        bankAccountEntity.setName(null);
    ...
    public void checkBalanceIsRequired() throws Exception {
        int databaseSizeBeforeTest = bankAccountRepository.findAll().size();
        // set the field null
        bankAccountEntity.setBalance(null);
    ...
    public void getAllBankAccounts() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(bankAccountEntity.getId().intValue())))
    ...
    public void getBankAccount() throws Exception {
        ...
        // Get the bankAccount
        restBankAccountMockMvc.perform(get("/api/bank-accounts/{id}", bankAccountEntity.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(bankAccountEntity.getId().intValue()))
    ...
    public void getBankAccountsByIdFiltering() throws Exception {
        ...
        Long id = bankAccountEntity.getId();
    ...
    public void getAllBankAccountsByUserIsEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccountEntity);
        UserEntity user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    public void getAllBankAccountsByOperationIsEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccountEntity);
        OperationEntity operation = OperationResourceIT.createEntity(em);
        em.persist(operation);
        em.flush();
        bankAccountEntity.addOperation(operation);
        bankAccountRepository.saveAndFlush(bankAccountEntity);
    ...
    public void updateBankAccount() throws Exception {
        ...
        BankAccountEntity updatedBankAccountEntity = bankAccountRepository.findById(bankAccountEntity.getId()).get();
        // Disconnect from session so that the updates on updatedBankAccountEntity are not directly saved in db
        em.detach(updatedBankAccountEntity);
        updatedBankAccountEntity
            .name(UPDATED_NAME)
            .guid(UPDATED_GUID)
            .bankNumber(UPDATED_BANK_NUMBER)
            .agencyNumber(UPDATED_AGENCY_NUMBER)
            ...
            .attachmentContentType(UPDATED_ATTACHMENT_CONTENT_TYPE)
            .description(UPDATED_DESCRIPTION);
        BankAccount bankAccount = bankAccountMapper.toDto(updatedBankAccountEntity);
    ...
    public void deleteBankAccount() throws Exception {
        ...
        restBankAccountMockMvc.perform(delete("/api/bank-accounts/{id}", bankAccountEntity.getId())
