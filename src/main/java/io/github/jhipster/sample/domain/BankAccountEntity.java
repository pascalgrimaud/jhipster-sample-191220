...
public class BankAccountEntity implements Serializable {
    ...
    public BankAccountEntity name(String name) {
        this.name = name;
        return this;
    }
    ...
    public BankAccountEntity guid(UUID guid) {
        this.guid = guid;
        return this;
    }
    ...
    public BankAccountEntity bankNumber(Integer bankNumber) {
    ...
    public BankAccountEntity agencyNumber(Long agencyNumber) {
    ...
    public BankAccountEntity lastOperationDuration(Float lastOperationDuration) {
    ...
    public BankAccountEntity meanOperationDuration(Double meanOperationDuration) {
    ...
    public BankAccountEntity meanQueueDuration(Duration meanQueueDuration) {
    ...
    public BankAccountEntity balance(BigDecimal balance) {
    ...
    public BankAccountEntity openingDay(LocalDate openingDay) {
    ...
    public BankAccountEntity lastOperationDate(Instant lastOperationDate) {
    ...
    public BankAccountEntity active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public BankAccountEntity accountType(BankAccountType accountType) {
    ...
    public BankAccountEntity attachment(byte[] attachment) {
    ...
    public BankAccountEntity attachmentContentType(String attachmentContentType) {
    ...
    public BankAccountEntity description(String description) {
    ...
    public BankAccountEntity user(UserEntity user) {
        this.user = user;
        return this;
    }
    ...
    public BankAccountEntity operations(Set<OperationEntity> operations) {
        this.operations = operations;
        return this;
    }

    public BankAccountEntity addOperation(OperationEntity operation) {
        this.operations.add(operation);
        operation.setBankAccount(this);
        return this;
    }

    public BankAccountEntity removeOperation(OperationEntity operation) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((BankAccountEntity) o).id);
    }
