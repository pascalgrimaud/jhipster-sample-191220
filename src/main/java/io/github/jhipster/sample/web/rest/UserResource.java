...
public class UserResource {
    ...
    public ResponseEntity<UserEntity> createUser(@Valid @RequestBody User userDTO) throws URISyntaxException {
    ...
    @PutMapping("/users")
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<User> updateUser(@Valid @RequestBody User userDTO) {
